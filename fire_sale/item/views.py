...
# def index(request):
#     user_category_views = CategoryViews.objects.filter(user_id=request.user.id)
#     return render(request, 'home/index.html', context={
#         'category_ids_ordered_by_views': user_category_views.order_by('-category_views').values_list('category_id', flat=True),  # to get favorite category ids
#         'categories': Category.objects.all(),  # to get category names
#         'items': Item.objects.all()
#     })

def index(request):
    user_category_views = CategoryViews.objects.filter(user_id=request.user.id)
    # CategoryViews.category.categoryviews_set.name
    return render(request, 'home/index.html', context={
