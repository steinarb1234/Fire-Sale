    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_date', models.DateField(blank=True, default=datetime.datetime(2023, 6, 2, 9, 4, 4, 740274, tzinfo=datetime.timezone.utc), null=True)),
                ...
                ('status', models.ForeignKey(default='Not sold', on_delete=django.db.models.deletion.PROTECT, to='item.itemstatuses')),
            ],
        ),
        migrations.CreateModel(
            name='ItemImage',
