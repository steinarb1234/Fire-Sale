...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ItemStatuses',
            fields=[
                ('status', models.CharField(default='Not sold', max_length=255, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='ItemStats',
            fields=[
                ...
                ('sold_date', models.DateField(blank=True, default='', null=True)),
                ('item', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='item.item')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='item.itemstatuses')),
            ],
        ),
        migrations.CreateModel(
            name='ItemImage',
